...
class RussiaFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view: View = inflater.inflate(R.layout.fragment_russia, container, false)
        val justPlate = view.findViewById<ImageView>(R.id.plate_rus)
    ...
    private val textWatcher = object : TextWatcher {
        ...
        override fun onTextChanged(p0: CharSequence?, p1: Int, p2: Int, p3: Int) {
            ...
            outputText?.setText(context?.let { dataHelper.findRegionByNumber(it, justRegion?.text.toString(), "rusRegion.json") })
